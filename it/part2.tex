...
\item \structure{\bftt{pgfplots}}: per creare grafi in \LaTeX
\item \structure{\bftt{listings}}: per la composizione di codici sorgente
...
\item Per saperne di pi\`u sul funzionamento di \bftt{latex} --- alcune risorse sono sulla prossima slide.
\end{itemize}
\end{frame}
...
\item\structure{ \href{http://tex.stackexchange.com/}{\TeX{} Stack Exchange}} --- fai domani e ottieni ottime risposte in pochissimo tempo
