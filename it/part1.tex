...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{In sintesi: un vero e proprio cambio di \structure{paradigma}}
...
\begin{itemize}
\item \keystrokebftt{\bs`} si usa per l'accento grave
\item \keystrokebftt{\bs'} si usa per l'accento acuto.
\end{itemize}
...
\begin{itemize}
\item Usa il circonflesso \keystrokebftt{\^} per gli apici e la linea bassa o \emph{underscore} \keystrokebftt{\_} per i pedici.
\begin{exampletwouptiny}
$y = c_2 x^2 + c_1 x + c_0$
\end{exampletwouptiny}
\vskip 2ex
...
\item \LaTeX{} offre molti comandi per le lettere greche e la notazione pi\'u comune.
\begin{exampletwouptiny}
